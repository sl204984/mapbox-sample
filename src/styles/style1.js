export default {
  ...
  "metadata": {
    "zjditu:k": {
      "7Y": "7Y,4v,lx,kR,JB,2Z,we,Kx,Nr,G9,MO,3X,Rn,ro,jP,nX,ak,q4,e8,VM,Yj,6Q,XY,QV,gZ,83R,PZ9,bD9,7MY,4Wv,lPx,kKR,JlB,25Z,wDe,Kox,NKr,GJ9,MDO,33X,Rln",
      "4v": "1r,OP,59,Ba,WG,DG,ZP,xw,0w,ya,mo,90m,zbb,vxB,oog,A9x",
      "Ax": "og,Ax,b9,8VR",
      "b9": "WbG,DoG,0gw,yPa,mNo,9km,zRb,vBB",
      "zb": "zb,vB",
      "og": "x8w",
      "P9": "qB4,e68,V6M,YDj,6wQ,XeY,QyV,g9Z,1Dr,OmP,529,Bva,WbG,DoG,x8w,0gw,yPa,mNo,9km,zRb,vBB,oDg,Amx,PN9,b19",
      "8R": "rko,jgP,n6X,a6k",
      "vB": "8R,P9,ZMP"
    }
  },
  ...
  "sources": {
    "osm1": {
      "type": "vector",
      "tiles": ["http://demo.zjditu.cn/vtiles/zhejiang/{z}/{x}/{y}.mvt?v={v}"]
    },
    "osm": {
      "type": "vector",
      "tiles": ["http://demo.zjditu.cn/vtiles/zhejiang/{z}/{x}/{y}.mvt?v={v}"]
    ...
    "tdt-zj": {
      "type": "raster",
      "tiles": ["http://localhost:9090/tile_zj/ZJEMAP_2D/wmts?layer=TDT_ZJEMAP&style=default&tilematrixset=default028mm&Service=WMTS&Request=GetTile&Version=1.0.0&Format=image%2Fjpgpng&TileMatrix={z}&TileCol={x}&TileRow={y}"],
      "tileSize": 256,
      "minzoom": 6,
      "maxzoom": 19
    }
